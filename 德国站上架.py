...
for i in range(1):
    ...
    file_path = AmazonDE.amazon(mubiao_file,source_file,CiBiao,account,TG_VP,price,shipping,leixing,style,fangfa,color_number,zuhe,zibiao,item_type,manufacturer)
    if TG_VP == 'P':
...
if TG == -1:
    ...
    utils.copy_file(mubiao_file, all_path, 'P')
